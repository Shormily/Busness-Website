    ...
    return (
      ...
      <div className="container ">
        <div className="row font text-light  ">
          <div className="col-12 col-md-6 col-lg-4 font "data-aos="fade-left" data-aos-duration="2000"
          ...
          <div className="col-12 col-md-6 col-lg-4"data-aos="zoom-in"data-aos-duration="2000">
            <h2>HEAD OFFICE</h2>
          ...
          <div className="col-12 col-md-6 col-lg-4"data-aos="fade-left" data-aos-duration="2000">
            <h2>LATEST POSTS</h2>
