        ...
        <div className="container card  shadow mt-5">
          <div className="row">
            ...
            >
              ...
              <p>
                <span>
                  <i className="fa-solid fa-location-dot mx-2 mt-2 fa-2x  text-primary"></i>
                </span>
                121 Wallstreet Street, New York , USA
              </p>
              <p>
                <span>
                  <i className="fa-solid fa-envelope mx-2 mt-2 fa-2x  text-primary"></i>
                </span>
                Shormilyrais@gmail.com
              </p>
              <p>
                <span>
                  <i className="fa-solid fa-phone mx-2 mt-2 fa-2x text-primary"></i>
                </span>
                + 013-121-55566{" "}
              </p>
            </div>
